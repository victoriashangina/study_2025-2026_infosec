...
![Подключение образ диска дополнений гостевой ОС](image/fig018new.png){#fig:018new width=70%}

## Установка имени пользователя и названия хоста

При установке виртуальной машины мы задали имя пользователя и имя хоста, удовлетворяющее соглашению об именовании. На моей операционной системе MacOS не получилось запустить образ диска допослнений гостевой ОС, поэтому я пропускаю этот шаг.

![Результат ошибки](image/fig021.png){#fig:021 width=70%}

# Домашнее задание

В окне терминала проанализируем последовательность загрузки системы, выполнив команду *dmesg* (рис. [-@fig:024])

![Команда dmesg](image/fig024.png){#fig:024 width=70%}

Далее посмотрим вывод этой команды с помошью *dmesg | grep -i ' '* (рис. [-@fig:025]), (рис. [-@fig:026])
...
4. Объем доступной оперативной памяти (Memory available) (рис. [-@fig:028])
5. Тип обнаруженного гипервизора (Hypervisor detected) (рис. [-@fig:029])
...
![Объем доступной оперативной памяти](image/fig028.png){#fig:028 width=70%}

![Тип обнаруженного гипервизора](image/fig029.png){#fig:029 width=70%}

![Тип файловой системы корневого раздела](image/fig030.png){#fig:030 width=70%}

![Последовательность монтирования файловых систем](image/fig031.png){#fig:031 width=70%}
